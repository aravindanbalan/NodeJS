           ...
           if(pathname == "/")
            ...
            if(pathname == "/chatHistory")
            {
                ...
                if(command == "addMsg")
                {
                    ...
                    models.Chat.findOneAndUpdate({"_id": id},{groupName: toGroup, userName: byUser, message : msg, timestamp : time, order : msgorder},{upsert: true,"new": true }, function (err, chats){
                        if (err){ throw err; } 
